  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
        <div className="bg-[#0C101B]/90 border border-slate-800/90 rounded-2xl p-5 shadow-lg flex items-center justify-between backdrop-blur-md">
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link
          href="/admin/eventos"
          className="group bg-[#0C101B]/90 border border-slate-800/90 rounded-2xl p-6 shadow-md hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(37,99,235,0.2)] transition flex flex-col justify-between backdrop-blur-md"
        >
          <div>
        ...
        <Link
          ...
          className="group bg-[#0C101B]/90 border border-slate-800/90 rounded-2xl p-6 shadow-md hover:border-amber-500/50 hover:shadow-[0_0_20px_rgba(212,175,55,0.2)] transition flex flex-col justify-between backdrop-blur-md"
        >
          <div>
        ...
        <Link
          href="/admin/usuarios"
          className="group bg-[#0C101B]/90 border border-slate-800/90 rounded-2xl p-6 shadow-md hover:border-slate-600 hover:shadow-[0_0_20px_rgba(148,163,184,0.15)] transition flex flex-col justify-between backdrop-blur-md"
        >
          <div>
